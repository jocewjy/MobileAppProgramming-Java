package umn.ac.id.week11_34804;
...
import umn.ac.id.week11_34804.databinding.ActivityMainBinding;
        ...
        postServices.getPosts().enqueue(new Callback< List< PostModel > >() {
            ...
            public void onResponse(Call< List< PostModel > > call, Response< List< PostModel > > response) {
                if(response.isSuccessful()) {
                    ...
                    Toast.makeText(getApplicationContext(), "Failed to get posts. Unknown API error.",
            ...
            public void onFailure(Call< List< PostModel > > call, Throwable t) {
                Toast.makeText(getApplicationContext(), "Failed to get posts. Check internet connection.",
                        Toast.LENGTH_LONG).show();
            }
        });
    }
